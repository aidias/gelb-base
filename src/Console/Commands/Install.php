        ...
        $this->table(
            ...
            [
                [
                    'file' => '.env',
                    'address' => './',
                    'details' => 'Generate a new key'
                ],
                [
                    'file' => 'ExampleComponent.vue',
                    'address' => './resources/js/components',
                    'details' => 'Delete file and components folder'
                ],
                [
                    'file' => 'app.js',
                    'address' => './resources/js',
                    'details' => 'Change file dependencies'
                ],
                [
                    'file' => 'bootstrap.js',
                    'address' => './resources/js',
                ...
                [
                    ...
                    'address' => './resources/sass',
                    'details' => 'Change file code'
                ],
                [
                    'file' => 'app.scss',
                    'address' => './resources/sass',
                ...
                [
                    ...
                    'address' => './resources/views/auth/passwords',
                    'details' => 'Change file code: adapt to visual design'
                ],
                [
                ...
                [
                    'file' => 'verify.blade.php',
                    'address' => './resources/views/auth',
                    'details' => 'Change file code: adapt to visual design'
                ],
                [
                    'file' => 'app.blade.php',
                    'address' => './resources/views/layouts',
                    'details' => 'Change file code: adapt to visual design'
                ],
                [
                    'file' => 'home.blade.php',
                    'address' => './resources/views',
                    'details' => 'Change file code: adapt to visual design'
                ],
                [
